						...
						switch (type) {
							...
							case 'block':
								...
								if (!this.active)
									...
									return '<em><a + this.value + '"  style="cursor: pointer;">' + this.value + '</a></em>';
							...
							case 'left':
								...
								return '<a + this.value + '"  style="cursor: pointer;">' + this.value + '</a>';

							case 'next':

								if (this.active) {
									return '<a + this.value + '" class="next" style="cursor: pointer;">Next &raquo;</a>';
								}
							...
							case 'prev':
								...
								if (this.active) {
									return '<a + this.value + '" class="prev"  style="cursor: pointer;">&laquo; Previous</a>';
								}
							...
							case 'first':
								...
								if (this.active) {
									return '<a + this.value + '" class="first"  style="cursor: pointer;">|&lt;</a>';
								}
							...
							case 'last':
								...
								if (this.active) {
									return '<a + this.value + '" class="prev" style="cursor: pointer;">&gt;|</a>';
								}
								return '<span class="disabled">&gt;|</span>';
		...
		if (Paging.opts["lock"]) {
		    ...
		    return Paging;
                ...
                function buffer_append(opts, data, type) {
                    ...
                    if (data["value"])
                        buffer+= type.replace(/<a/i, '<a  style="cursor: pointer;" data-page="' + data["value"] + '"');
                    else
                        buffer+= type;
                }
